...
# weight_vector_ls = []
# regularizor_ls = []
# # For plotting of all the parametrs at the end
# hold_marsh_weights = {}
# hold_marsh_regularizors = {}
# # Set random seed to try and reduce variations in predictions
# seed(123)
...
#         # Metrics: particularly for MAE
#         r2 = r2_score(y_test, ypred)
#         r2_ls.append(r2)
#         mae = mean_absolute_error(y_test, ypred)
#         mae_ls.append(mae)
#
#     # Average over the Kfold first
...
#
# ax.annotate("Median r-squared = {:.3f}".format(r2_final_median), xy=(30, 210), xycoords='axes points',
#             bbox=dict(boxstyle='round', fc='w'),
#             size=8, ha='left', va='top')
# ax.annotate("Median MAE = {:.3f}".format(mae_final_median), xy=(30, 190), xycoords='axes points',
#             bbox=dict(boxstyle='round', fc='w'),
#             size=8, ha='left', va='top')
# plt.show()
